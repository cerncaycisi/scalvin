...
Claude Code may use normal filesystem tools. Keep mechanical details
unobtrusive, but never hide what personal data will be stored, what may be sent
to a model provider, or how the user can pause, correct, export, or delete it.
